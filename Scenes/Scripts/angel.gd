...
# reuseable method for changing to another scene after a black fade-in
...
func _on_SMRT_dialog_control(info):
	...
	if (info.chapter == "angel" and info.dialog == "1" and info.last_text_index == 3):
		music_handler.get_node("ambient").play()
		get_node("BG").fade_out()
	elif (info.chapter == "angel" and info.dialog == "1" and info.last_text_index == 59): 
		delayed_dialogue("angel", "2", null, true)
	elif (info.chapter == "angel" and info.dialog == "2" and info.last_text_index == 4):
		get_node("BG").fade_out()
	elif (info.chapter == "angel" and info.dialog == "2" and info.last_text_index == 10):
		music_handler.get_node("ambient").stop()
		
		change_scene("res://Scenes/puzzle_1.tscn")
